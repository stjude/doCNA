...
model_presets_2 = {'A'   : Preset(A = lambda m,dv,m0: -m0/2,
                                  ...
                                  k = lambda m,dv,m0: 2*dv/(0.5+dv) if (m/m0 > 0.9/2) & (m/m0 < 1.1/2) else np.nan,
                   ...
                   'AA'  : Preset(A = lambda m,dv,m0: 0,
                                  ...
                                  C = lambda m,dv,m0: m0,
                                  D = lambda m,dv,m0: m,
                                  k = lambda m,dv,m0: 2*dv if (m/m0 > 0.9) & (m/m0 < 1.1) else np.nan,
                   ...
                   'AAB' : Preset(A = lambda m,dv,m0: m0/2,
                                  ...
                                  C = lambda m,dv,m0: m0,
                                  D = lambda m,dv,m0: -m0*(2*dv/(0.5-dv))/2+m,
                                  k = lambda m,dv,m0: 2*dv/(0.5-dv) if (m/m0 > 2.9/2) & (m/m0 < 3.1/2) else np.nan,
                                  m = lambda k,m0: (2+k)*m0/2,
                                  ai = lambda k,m0: k/(2*(2+k))),
